...
#Region "Functions"
    ...
    Private Sub GetListing(boiNo As String, importDate As String, invoiceNo As String, desc As String, equipmentId As String,
                           assetTag As String, validDate As String)
        ...
        Try
            ...
            sSQL = sSQL & ") "
            sSQL = sSQL & "WHERE 1=1 And ROWNUM <= 500 "
