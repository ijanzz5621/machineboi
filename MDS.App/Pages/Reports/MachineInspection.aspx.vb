...
#Region "Functions"
    ...
    Private Sub GetListing(boiNo As String, importDate As String, invoiceNo As String, desc As String,
        ...
        Try
            ...
            sSQL = sSQL & "WHERE a.good_type_code = '02' AND 1=1 AND ROWNUM <= 500 "
